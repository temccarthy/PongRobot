...
img1 = cv2.imread("rack1.JPG",1)
img2 = cv2.imread("rack2.JPG",1)
img3 = cv2.imread("rack3.JPG",1)
img4 = cv2.imread("rack4.JPG",1)
img5 = cv2.imread("rack5.JPG",1)
img6 = cv2.imread("rack6.JPG",1)
img7 = cv2.imread("Pong5flash.JPG",1)
...
##    mask2 = cv2.inRange(hsv_img,lowerRed2,upperRed2) #create mask
    ...
    output_img = img.copy() # object copier
...
#cv2.imshow("combo",cv2.resize(mask_images(img5)[1],(0,0),fx=.25,fy=.25))
